...
import { Brain, BriefcaseIcon, CopyPlus, LineChart, TrendingDown, TrendingUp } from "lucide-react";
                                    ...
                                    if(active && payload && payload.length) {
                                        return (
                                            <div className="bg-background border rounded-lg p-2 shadow-md">
                                                ...
                                                {payload.map((item) => (
                                                    <p key={item.name} className="text-sm">{item.name}: {item.value * 80}K</p>
                                                ))}
                                            </div>
                                        );
                                    }
